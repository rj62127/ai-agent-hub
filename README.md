...
<p align="center">
  <a href="https://www.linkedin.com/in/rajan62127/">
    <img src="https://img.shields.io/badge/-Follow%20Rajan%20on%20LinkedIn-blue?logo=linkedin&style=flat-square" alt="LinkedIn">
  </a>
</p>
...
1. **Clone the repository** 
    ...
    ```bash 
    git clone https://github.com/rj62127/ai-agent-hub.git 
    ```

2. **Navigate to the desired project directory**

    ```bash 
    cd ai-agent-hub/starter_ai_agents/ai_travel_agent
    ```
...
This repository is a **modified and personalized version** of the original open-source project created by **Shubham Saboo**.

### Original Source
🔗 https://github.com/Shubhamsaboo/awesome-llm-apps

### Purpose of This Fork
- Created for **personal learning, experimentation, and customization**
- Branding, links, and references have been modified or removed
- Content structure is adapted for individual and educational use

### Credit
All original ideas, architecture, and foundational work belong to  
**Shubham Saboo and contributors**.

This fork **does not claim original authorship** of the core project.

---

### Maintained & Modified By
**Rajan**  
🔗 https://www.linkedin.com/in/rajan62127/
